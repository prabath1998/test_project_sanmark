              ...
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Set Ground Radius</h3>
                    <div class="mt-2">
                        <form method="POST" action="{{ route('settings.save') }}" class="mb-4 mr-2">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                {{-- <button onclick="location.href='{{ url('home') }}'" class="w-full px-4 py-2 font-bold text-white bg-red-500 rounded-full hover:bg-red-700 focus:outline-none focus:shadow-outline">Close</button> --}}
                                <a href="{{route('home')}}" class="w-full ml-3 text-center px-4 py-2 font-bold text-white bg-red-300 rounded-full hover:bg-red-600 focus:outline-none focus:shadow-outline">Close</a>
                            </div>
                        </form>
                    </div>
                  </div>
